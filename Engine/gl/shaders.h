...
namespace gl
{
    namespace shaders
    {
        ...
        void main()
        {
            vec4 effect_color = vec4(0, 0, 0, 1.0 - texture(sampler2d, uv).r);
            //v_fragmentColor * vec4(u_effectColor.rgb, u_effectColor.a * outlineAlpha * (1.0 - fontAlpha));
            
            fragment_color = effect_color * color;
        })";
